...
namespace Forms.Infrastructure.Migrations
{
    ...
    [Migration("20241015191851_AddTemplateRoles")]
    partial class AddTemplateRoles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forms.Domain.TemplateManagement.Entities.TemplateRoles", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TemplateId")
                        .HasDatabaseName("ix_template_roles_template_id");

                    b.HasIndex("user_id")
                        .HasDatabaseName("ix_template_roles_user_id");
            ...
            modelBuilder.Entity("Forms.Domain.TemplateManagement.Aggregate.Template", b =>
                {
                    b.HasOne("Forms.Domain.TemplateManagement.Entities.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Forms.Domain.TemplateManagement.Entities.TemplateRoles", b =>
                {
                    b.HasOne("Forms.Domain.TemplateManagement.Aggregate.Template", "Template")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_template_roles_templates_template_id");

                    b.HasOne("Forms.Domain.TemplateManagement.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_template_roles_users_user_id");
